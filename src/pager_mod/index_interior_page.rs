...
pub struct IndexInteriorPage<'a>{
    pub contents:&'a Vec<u8>,
    pub content_offset:u8,
    pub cell_count:u16,
}

struct IndexInteriorPageCell{
}


impl IndexInteriorPage{
    pub fn new(contents:&Vec<u8>,content_offset:u8,cell_count:u16) -> IndexInteriorPage{
        IndexInteriorPage{
            contents,
            content_offset,
            cell_count
    ...
    pub fn read_cells(&self) -> Vec<IndexInteriorPageCell> {
